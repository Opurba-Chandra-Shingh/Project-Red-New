...
public class Edit_Controller {
    ...
    void handleSave(ActionEvent event) {
        ...
        try {
            ...
            ArrayList<NotificationDetails> notis = gson.fromJson(new FileReader("D:\\project-redpulse-new\\src\\main\\resources\\com\\example\\projectredpulsenew\\Noti.json"), notiType);
            ...
            try (FileWriter writer1 = new FileWriter("D:\\project-redpulse-new\\src\\main\\resources\\com\\example\\projectredpulsenew\\Noti.json")) {
                gson.toJson(notis, writer1);
            }

            // 3️⃣ Update PostDetails.json
            Type postType = new TypeToken<ArrayList<PostDetails>>(){}.getType();
            ArrayList<PostDetails> posts = gson.fromJson(new FileReader("D:\\project-redpulse-new\\src\\main\\resources\\com\\example\\projectredpulsenew\\PostDetails.json"), postType);
            ...
            try (FileWriter writer2 = new FileWriter("D:\\project-redpulse-new\\src\\main\\resources\\com\\example\\projectredpulsenew\\PostDetails.json")) {
