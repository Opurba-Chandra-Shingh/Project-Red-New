...
public class AdminPanelController {
    ...
    private final String POST_FILE = "src/main/resources/com/example/projectredpulsenew/PostDetails.json";
    private final String USER_FILE = "src/main/resources/com/example/projectredpulsenew/UserDetails.json";
    ...
    private HBox createUserCard(User user, List<User> allUsers) {
        ...
        VBox infoBox = new VBox(2);
        String roleText = user.isAdmin() ? " (ADMIN)" : "";
        infoBox.getChildren().addAll(
        ...
        if(user.isAdmin()) infoBox.getChildren().get(0).setStyle("-fx-text-fill: darkblue; -fx-font-weight: bold;");
